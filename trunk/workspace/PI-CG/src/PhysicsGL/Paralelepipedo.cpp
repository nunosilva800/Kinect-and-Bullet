...
{
    float largura = ((v1->x - v2->x) < 0) ? -(v1->x - v2->x)/2.0 : (v1->x - v2->x)/2.0;
    float altura = ((v1->y - v2->y) < 0) ? -(v1->y - v2->y)/2.0 : (v1->y - v2->y)/2.0;
    float profundidade = ((v1->z - v2->z) < 0) ? -(v1->z - v2->z)/2.0 : (v1->z - v2->z)/2.0;
