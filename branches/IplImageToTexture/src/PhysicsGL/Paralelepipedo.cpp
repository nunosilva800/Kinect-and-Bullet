...
Paralelepipedo::Paralelepipedo(float largura, float profundidade, float altura){
	Math::identity4(this->objTransMat);
	this->setInitialColors();
	this->contructParalelepipedo(largura, profundidade, altura);
}

Paralelepipedo::Paralelepipedo(vector3 *v1, vector3 *v2){
	Math::identity4(this->objTransMat);
	this->setInitialColors();
	this->contructParalelepipedo(fabs(v1->x - v2->x),fabs(v1->z - v2->z),fabs(v1->y - v2->y));
}
 ...
 *
 */
void Paralelepipedo::contructParalelepipedo(float largura, float profundidade, float altura){
